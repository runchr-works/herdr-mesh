...
export const integrationTools = [
    {
        ...
        description: "Show which agent integrations herdr knows about and their install status (pi, omp, claude, codex, opencode, hermes, qodercli, …). Use this to discover what agent types are available in this herdr install.",
        inputSchema: {
            outdated_only: z
                .boolean()
                .optional()
