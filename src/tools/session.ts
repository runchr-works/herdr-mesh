...
export const sessionTools: ToolDef[] = [
  {
    ...
    description:
      "List herdr persistent sessions. Sessions survive disconnects and can be shared/reattached locally or over SSH.",
    inputSchema: {},
  ...
  },
  {
    ...
    description:
      "Stop a named session (use 'default' to target the default session). Stops the server-side session; clients detach.",
    inputSchema: {
